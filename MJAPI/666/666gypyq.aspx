<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="666gypyq.aspx.cs" Inherits="MJAPI._666._666gypyq" %>
    ...
    (function () {
        $(function () {
            $("#yy").click(function () {
                ...
                $.post("/HD/add2", { name: "贵阳-朋友圈-" + name, phone: phone, code: code }, function (data) {
