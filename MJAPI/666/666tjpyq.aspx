<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="666tjpyq.aspx.cs" Inherits="MJAPI._666._666tjpyq" %>
<!doctype html>
<html>
<head>
...
<body>
    <div id='content'>
        <img src='img/666tj.png' class='img' />
        <div class='bottom'>
    ...
    (function () {
        $(function () {
            $("#yy").click(function () {
                ...
                $.post("/HD/add2", { name: "天津-朋友圈-" + name, phone: phone, code: code }, function (data) {
