...
namespace DbHelper
{
    public class Sqlhelperhd
    {
        private static readonly string connectionString = "user id=sa;data source=118.144.76.61;initial catalog=gggggg;pwd=MJ100@20150403ghj;";
